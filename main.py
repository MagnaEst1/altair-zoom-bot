...
class ZoomBotGUI:
    def __init__(self, name):
        ...
        self.main_bg = PhotoImage(file='assets/gui')
        self.button = PhotoImage(file="assets/gui1")
    ...
    def show_error(self, text, pos):
        self.err_text = Label(self.window, text=text, font=("montserrat", 10), fg="red", bg="#E8E7E3")
    ...
    def home_page(self):
        ...
        self.select_weekday['values'] = ('Everyday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday')
...
if __name__ == "__main__":
    gui = ZoomBotGUI('Altair by MagnatheGreat')
